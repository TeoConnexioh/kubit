...
(function () {
  ...
  const DATA = {
    ai: {
      title: "인공지능 (AI)",
      desc: "사람이 하던 지적인 일 — 보고, 듣고, 판단하고, 말하는 것 — 을 기계가 흉내 내게 하는 모든 기술의 총칭. 규칙을 사람이 직접 짜 넣던 옛날 방식까지 포함하는, 가장 바깥의 울타리입니다.",
      chapter: "이 강의 전체의 무대", link: null,
    },
    ml: {
      title: "기계학습 (Machine Learning)",
      desc: "AI 중에서도 '규칙을 사람이 넣지 않고, 데이터를 보며 스스로 배우는' 갈래입니다. 오늘날 우리가 AI라 부르는 것의 대부분이 사실 여기에 속합니다.",
    ...
    llm: {
      title: "LLM (대규모 언어 모델)",
      desc: "트랜스포머를 인터넷 규모의 글로, 수천억 개의 연결로 초거대하게 키운 것. ChatGPT·Claude 같은 서비스가 여기 속합니다. 이 지도의 가장 안쪽 핵이죠.",
      chapter: "챕터 06 · LLM", link: "#llm",
    },
    supervised: {
      title: "지도학습",
      desc: "'정답이 붙은' 데이터로 배우는 방식. 고양이 사진에 '고양이'라는 답을 달아 보여주는 식입니다. 챕터 03의 '직선 맞히기'가 대표적인 예예요.",
